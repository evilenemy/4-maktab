      ...
      <section className="events">
        <div className="wrapper">
          ...
          >
            <SwiperSlide className="card-event">
              ...
              <div className="card-body">
                ...
                <p>
                  ...
                  eos ducimus voluptatum sapiente optio debitis est unde
            ...
            <SwiperSlide className="card-event">Slide 3</SwiperSlide>
            <SwiperSlide className="card-event">Slide 4</SwiperSlide>
            <SwiperSlide className="card-event">Slide 5</SwiperSlide>
            <SwiperSlide className="card-event">Slide 6</SwiperSlide>
            <SwiperSlide className="card-event">Slide 7</SwiperSlide>
            <SwiperSlide className="card-event">Slide 8</SwiperSlide>
            <SwiperSlide className="card-event">Slide 9</SwiperSlide>
          </Swiper>
        </div>
      </section>
    </div>
